...
namespace RationalNumbers
{
    ...
    public class Numbers
    {
        ...
        {
            string outString = $"{this.Numerator}/{this.Denumerator}";
        ...
        public static Numbers operator *(Numbers fraction1, Numbers fraction2)
        { 
            return new Numbers(fraction1.numerator * fraction2.numerator, fraction1.denumerator * fraction2.denumerator);
        }
        ...
        public static Numbers operator /(Numbers fraction1, Numbers fraction2)
        {
            ...
            return new Numbers(fraction1.numerator * fraction2.denumerator, fraction1.denumerator * fraction2.numerator);
        }
        public static Numbers operator %(Numbers fraction1, Numbers fraction2)
        {
            nok(fraction1, fraction2);
            int num = fraction1.numerator - (fraction2.numerator * (fraction1.numerator / fraction2.numerator));
            return new Numbers(num, fraction1.denumerator);
        }

        public static implicit operator float(Numbers fraction)
        {
            float num, den;
            num = fraction.numerator;
            den = fraction.denumerator;
            return num/den;
        }
        public static implicit operator int(Numbers fraction)
        {
            int num, den;
            num = fraction.numerator;
            den = fraction.denumerator;
